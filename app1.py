...
# --- AUDIO DEL ESTADIO (SIEMPRE ACTIVO) ---
# Usamos un reproductor de audio oculto con HTML para forzar el autoplay de manera más efectiva
import streamlit as st
import base64

audio_file = "Stadium.mp3"  # descarga un audio y colócalo en tu proyecto
...
audio_file = r"C:\Users\gaf_r\OneDrive\Desktop\phyton\stadium.mp3"

if st.button("▶️ Lanzar Tiro Libre"):
    st.markdown(f"""
    <audio autoplay loop>
...
# --- NUEVO: CUADRO PARA MEDIR TIEMPO EN CUALQUIER POSICIÓN ---
st.sidebar.markdown("---")
