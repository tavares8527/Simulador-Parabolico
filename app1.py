...
# --- AUDIO DEL ESTADIO FIJO ---
# Se coloca visible en la barra lateral para evitar los bloqueos de "autoplay" de los navegadores.
st.sidebar.header("🔊 Ambiente de Estadio")
audio_url = "https://actions.google.com/sounds/v1/crowds/stadium_crowd_exterior.ogg"
st.sidebar.audio(audio_url, format="audio/ogg", autoplay=True, loop=True)
st.sidebar.caption("Si no escuchas nada al entrar, presiona 'Play' en el reproductor de arriba. Las políticas del navegador a veces bloquean el audio automático.")
st.sidebar.markdown("---")
