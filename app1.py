...
# Aquí colocas el nombre exacto de tu archivo de audio
archivo_audio = "estadio.mp3" 

# Reproductor de Streamlit configurado para autoplay y loop
st.audio(archivo_audio, format="audio/mpeg", autoplay=True, loop=True)
